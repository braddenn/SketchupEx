...
#
  ...
  #
  def self.align( instRef, instRotate )
    ...
    # get the angle
    angle = self.get_angle( instRotate.transformation.xaxis, instRef.transformation.xaxis)
  ...
  self.reset
  $boxDef1 = self.makeBoxDef( 2, 30, 15 )
  $boxDef2 = self.makeBoxDef( 10, 20, 30 )
  #make an instance of a box at 10,10,10
  makeInstanceOfDefAt($boxDef1, 10,10,10)
  inst0 = $boxDef1.instances[0]

  self.makeInstanceOfDefAt($boxDef2, -40,40,40)
