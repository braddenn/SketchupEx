...
def SketchUpEx.makeDefs
  $cubeDef = SketchUpEx.makeCubeDef( 10, 10, 10 )
end
#
...
def SketchUpEx.trim( instA, instB )
#  grp = instA.trim instB
#  SketchUpEx.printEntities grp.entities
end
  
SketchUpEx.makeDefs
SketchUpEx.makeInstances
SketchUpEx.move $cubeDef.instances[1], 8, 0, 0
SketchUpEx.trim $cubeDef.instances[0], $cubeDef.instances[1]
