...
def ex_point_in_polygon_2D
 ...
 #
 ex_closest_points
 ex_fit_plane_to_points
 ex_intersect_line_line
 ex_intersect_line_plane
 ex_intersect_plane_plane
 ex_linear_combination
 ex_point_in_polygon_2D
