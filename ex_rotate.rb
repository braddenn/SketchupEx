...
SketchUpEx.makeBoxDef( 60, 30, 15 )

#make an instance of a box at 0,0,0
SketchUpEx.makeInstanceOfDefAt($boxDef, 0,0,0)
...
SketchUpEx.rotate( inst, pt, vector, angle)
...
SketchUpEx.makeInstanceOfDefAt($boxDef, 50,50,50)
