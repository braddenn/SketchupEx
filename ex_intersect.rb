...
def SketchUpEx.int_line_line # OK
...
def SketchUpEx.int_line_plane # OK
...
def SketchUpEx.int_plane_plane #
  # Defines a plane with it's normal parallel to the x axis.
...
def SketchUpEx.int_linear_combo
...
def SketchUpEx.point_in_triangle
 ...
 def SketchUpEx.point_in_quadrangle
  # Create a point that we want to check. (Note that the 3rd coordinate,
  # the z, is ignored for purposes of the check.)
  point = Geom::Point3d.new(5, 0, 10)
...
p "intersect line to line #{SketchUpEx.int_line_line}"
p "intersect line to plane #{SketchUpEx.int_line_plane}"
p "intersect plane to plane #{SketchUpEx.int_plane_plane}"
p "linear combination, expect 7.75 #{SketchUpEx.int_linear_combo}"
p "point_in_polygon_2D, triangle #{SketchUpEx.point_in_triangle}"
p "point_in_polygon_2D, quad #{SketchUpEx.point_in_quadrangle}"
